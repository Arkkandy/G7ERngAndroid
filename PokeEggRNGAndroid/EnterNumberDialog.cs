...
{
    public class EnterNumberDialog : Dialog
    {
        ...
        public EnterNumberDialog(Context context) : base(context)
        {
        ...
        public void InitializeDialog(Action<int> yesAction, Action noAction)
        {
        ...
        private void YesFunc()
        {
            ...
            {
                yesAction(int.Parse(editText.Text));
                this.Dismiss();
            }
            else
            {
